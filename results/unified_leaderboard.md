...
_Cross-surface compliance-framework breakdowns (HIPAA / GDPR / CCPA / SOC 2 / PCI DSS / DPDPA), unified across text + image + trace: [results/framework_coverage.md](framework_coverage.md). Per-surface details: [text](../text/results/framework_coverage.md) · [image](../image/results/framework_coverage_sample.md) · [trace](../trace/results/framework_coverage_sample.md) (when replays available)._
